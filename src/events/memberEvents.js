...
async function startCaptcha(ctx, group, member) {
  ...
  try {
    // BUG FIX: "permissions" endi to'g'ridan-to'g'ri 2-argument (Bot API
    // talabiga mos) — avval boshqa parametr bilan aralashtirilgan bo'lib,
    // Telegram cheklovni umuman qo'llamasdi (lekin xato ham tashlamasdi).
