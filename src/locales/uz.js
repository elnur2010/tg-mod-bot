export default {
  ...
  // ===== CAPTCHA (qo'shimcha) =====
  captcha_not_bot_btn: "✅ Men bot emasman",
  captcha_join_prompt: "👋 {{mention}}, siz botmasligingizni tasdiqlang.\n\n{{minutes}} daqiqa ichida pastdagi tugmani bosing.",
  captcha_welcome_after_verify: "🎉 {{mention}}, guruhimizga xush kelibsiz!",
