export default {
  ...
  captcha_join_prompt: "👋 {{mention}}, пожалуйста, подтвердите, что вы не бот.\n\nНажмите кнопку ниже в течение {{minutes}} мин.",
  captcha_welcome_after_verify: "🎉 {{mention}}, добро пожаловать в нашу группу!",
