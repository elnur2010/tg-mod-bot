...
### ⚠️ MUHIM: Bot Ruxsatlari (Telegram Sozlamalari)

Botni guruhlarga qo'shganda va ruxsatlar talab etilganda **albatta quyidagi ruxsatlarni belgilang:**

- ✅ **Xabarlarni o'chirish** — o'chirim, spam filtrlar uchun kerak
- ✅ **A'zolarni cheklash** — mute/unmute/ban komandalar uchun **SHART**
- ✅ **Foydalanuvchilarni banning** — ban komandalar uchun
- ✅ **A'zolar haqida ma'lumot** — admin status tekshiruvi uchun
- ✅ **Inline tugmalarni boshqarish** — sozlamalar menyusi uchun

**Agar "Restrict members" (A'zolarni cheklash) ruxsati bo'lmasa:**
- 🔴 `/ovozsiz` (mute) — ishlamaydi
- 🔴 `/ovoz_yoqish` (unmute) — ishlamaydi
- 🔴 Captcha — ishlamaydi
- 🔴 Anti-reyd himoyasi — ishlamaydi

👉 **Bot egasiga:** `@BotFather`da botni tanlang → `Edit Bot` → `Edit Commands` va `Edit Default Admin Rights` orqali ruxsatlarni o'rnatish mumkin.
